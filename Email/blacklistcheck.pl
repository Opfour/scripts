...
%ZoneTags = (
	...
	#
	#"default"	=> "rbl",
	"default"	=> [qw(ahbl zen spamcop njabl tio barr uce1 uce2 uce3 back)],
	
	###
	#
	# Abusive Host Block List <http://www.ahbl.org/>
	#
	"ahbl"           => "dnsbl.ahbl.org",
	...
	###
	#  
	# Barracuda Reputation Block List <http://barracudacentral.org/rbl/how-to-use>
	#
	"barr"		=> "b.barracudacentral.org",

	###
	#          
	# Tiopan Blacklist <http://www.tiopan.com/blacklist.php>
	#                        
	"tio"          => "bl.tiopan.com",
	 ...
	 # 
	 #                               
	 "uce1"          => "dnsbl-1.uceprotect.net",
	 "uce2"          => "dnsbl-2.uceprotect.net",
	 "uce3"          => "dnsbl-3.uceprotect.net",
	 "back"		 => "ips.backscatterer.org",
	...
	#
	"all" => [qw(ahbl zen rsl pdl ordb njabl xbl fiveten spamcop hil rfci
		opm-all dsbl maps barr tio)]
...
=head1 SEE ALSO
 ...
 zen		http://www.spamhaus.org/SBL/
 spamcop	http://spamcop.net/bl.shtml
 xbl		http://www.selwerd.cx/xbl/
 tio		http://www.tiopan.com/blacklist.php
 barr		http://barracudacentral.org/rbl
 rash		http://rashbl.com/
